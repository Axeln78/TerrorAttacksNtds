...
%\movie[]{}{predictionAnimation.mp4}
%\movie[height = 0.6\textwidth, width = 0.8\textwidth]{}{predictionAnimation.mp4}
%\includemedia[]{alt content}{../notebooks/pics/predictionAnimation.mp4}
\begin{figure}[H]
\begin{center}
